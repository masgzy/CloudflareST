...
**本项目基于开源项目[XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) 修改。
感谢原作者[XIU2](https://github.com/XIU2/)的贡献**

[![Go Version](https://img.shields.io/github/go-mod/go-version/masgzy/CloudflareST.svg?style=flat-square&label=Go&color=00ADD8&logo=go)](https://github.com/masgzy/CloudflareST)
[![Release Version](https://img.shields.io/github/v/release/masgzy/CloudflareST.svg?style=flat-square&label=Release&color=00ADD8&logo=github)](https://github.com/masgzy/CloudflareST/releases/latest)
[![GitHub license](https://img.shields.io/github/license/masgzy/CloudflareST.svg?style=flat-square&label=License&color=00ADD8&logo=github)](https://github.com/masgzy/CloudflareST)
[![GitHub Star](https://img.shields.io/github/stars/masgzy/CloudflareST.svg?style=flat-square&label=Star&color=00ADD8&logo=github)](https://github.com/masgzy/CloudflareST)
[![GitHub Fork](https://img.shields.io/github/forks/masgzy/CloudflareST.svg?style=flat-square&label=Fork&color=00ADD8&logo=github)](https://github.com/masgzy/CloudflareST)
...
> _分享原作者其他开源项目：[**TrackersList.com** - 全网热门 BT Tracker 列表！有效提高 BT 下载速度~](https://github.com/XIU2/TrackersListCollection) <img src="https://img.shields.io/github/stars/XIU2/TrackersListCollection.svg?style=flat-square&label=Star&color=4285dd&logo=github" height="16px" />_  
...
**初衷:** 因觉得 Rust 版本增加了新参数，故选择在更熟悉的 Go 原版基础上进行改进。

**主要改动:** 集成了源自 Rust 版本的一些优秀特性与优美界面。

**为保证运行时终端的简洁和保留原作者署名，声明信息仅在首次运行时输出**(判断靠.first_run文件，此文件也会放在发行版的压缩包里面)

**注:** 在修改本项目时，我借助了生成式AI大语言模型来进行一些代码修改。最终的所有修改均由我本人决策并合并，并由我本人进行测试，以确保项目质量。

我们理解并尊重每位开发者对代码编写方式的不同偏好。特此说明，以便您能基于完整信息做出使用判断。

本人是一个初学者，可能有一些行为比较让人难绷，如果您觉得我哪里做的不对，请随时提出，我会努力改进的。
...
以下命令仅为示例，版本号和文件名请前往 [**Releases**](https://github.com/masgzy/CloudflareST/releases) 查看。
...
wget -N https://github.com/masgzy/CloudflareST/releases/download/v2.3.4/cfst_linux_amd64.tar.gz
# 如果你是在国内网络环境中下载，那么请使用下面这几个镜像加速之一：
# wget -N https://ghfast.top/https://github.com/masgzy/CloudflareST/releases/download/v2.3.4/cfst_linux_arm64.tar.gz
# wget -N https://wget.la/https://github.com/masgzy/CloudflareST/releases/download/v2.3.4/cfst_linux_arm64.tar.gz
# wget -N https://ghproxy.net/https://github.com/masgzy/CloudflareST/releases/download/v2.3.4/cfst_linux_arm64.tar.gz
# wget -N https://hk.gh-proxy.com/https://github.com/masgzy/CloudflareST/releases/download/v2.3.4/cfst_linux_arm64.tar.gz
...
本项目基于开源项目[XIU2/CloudflareSpeedTest]修改，下方二维码为原作者的捐赠渠道，感谢原作者的贡献。本项目捐赠渠道: null
## 如果帮到你的话就 "打赏" 一下吧~🎉✨
